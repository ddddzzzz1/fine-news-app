...
| `impact_analysis` | map | Contextual insights for the user. `{ summary: "One-liner", investment: "Investment context", employment: "Job market context" }`. Takes precedence over `key_data_points`. |
