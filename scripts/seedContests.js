...
const contestData = [
    ...
    {
        id: "contest-2",
        title: "피상범죄 예방 콘텐츠 챌린지",
        organizer: "광주경찰청",
        category: "대외활동",
        start_date: new Date("2025-05-15").toISOString(),
        end_date: new Date("2025-07-31").toISOString(),
        image_url: "",
        description: "피상범죄 예방 메시지를 담은 영상/포스터를 제작해 캠페인을 홍보하는 미션형 대외활동입니다.",
        requirements: "전국 대학생",
    ...
    {
        id: "contest-6",
        title: "ESG 전략 자격증 부트캠프",
        organizer: "Fine ESG Lab",
        category: "자격증",
        start_date: new Date("2025-05-01").toISOString(),
        end_date: new Date("2025-06-30").toISOString(),
        image_url: "",
        description: "ESG 전략 실무 교육과 검정 대비 과제가 포함된 집중 자격 과정입니다.",
        requirements: "대학생, 대학원생, 직장인 팀 참가 가능",
        benefits: "자격시험 응시권, 멘토링, ESG 프로젝트 컨설팅",
